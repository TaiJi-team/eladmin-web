<template>
  <div style="background: #f5f5f5">
    ...
    <div class="div_body">
      ...
      <div class="bg-white default-mar-top small-mar-bottom min-page clearfix box-sizing finance-head"> <div class="fl pos-center head-img"> <img src="https://celoan-file.oss-cn-shenzhen.aliyuncs.com/celoan/crop/2019/09/10/2019091005182633856.png" class="middle-center" alt=""> </div> <div class="overflow"> <h2 class="head-name">北京农村商业银行股份有限公司<span class="release-time">发布时间：2019-09-11</span></h2>
        <p class="head-info">北京农商银行作为北京市属国有金融企业，秉承“稳健可持续全面发展”的经营理念，认真贯彻落实宏观调控政策和金融监管要求，着力打造“流程银行、特色银行、精品银行”，持续调整结构、夯实基础、提升质效，规模、效益、质量实现协调发展，经营质态呈现持续向好的良好势头，开启“深化改革、创新发展”崭新阶段。</p> </div> </div>
      <div class="bg-white small-mar-bottom min-page finance-achieve"> <ul class="clearfix achieve-list"> <li class="fl box-sizing"> <div class="ac line-middle item-cont"> <p class="item-num">0<span class="unit">次</span></p> <p class="item-t"> <img src="res/images/f-i-2.png" alt="">成功对接 </p> </div> </li> <li class="fl box-sizing"> <div class="ac line-middle item-cont"> <p class="item-num">2<span class="unit">个</span></p> <p class="item-t"> <img src="res/images/f-i-3.png" alt="">金融产品数 </p> </div> </li> <li class="fl box-sizing"> <div class="ac line-middle item-cont"> <p class="item-num">-<span class="unit">分</span></p> <p class="item-t"> <img src="res/images/f-i-4.png" alt="">综合评价 </p> </div> </li> </ul> </div>
      ...
      <div id="page_template_body_id" class="min-page small-mar-top search-result mar-top-bottom">
        ...
        <ul v-show="isBlock" id="productListBlock" class="clearfix product-list">
          <router-link to="/fin-market/dnsyh" tag="li">
            <div class="bg-white line-action-hover item-main"> <a>
              <div class="item-title">
                ...
                <div class="overflow title-cont">
                  <h2 class="text-ellipsis item-name"> <span class="line-middle sub-name">首都职工创业小额贷款</span> <br> <em class="org-name">北京农村商业银行股份有限公司</em> </h2>
              ...
              <router-link class="g-bg g-shadow item-btn" to="/fin-market/nsyh" tag="button">查看详情</router-link>
              <div class="line-top" />
        ...
        <ul v-show="!isBlock" id="productListLine" class="product-list-line">
          <router-link to="/fin-market/nsyh" tag="li"> <a>
            ...
            <div class="fl item-title"> <span class="t">北京农商银行</span>
