      ...
      <div id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <div id="financingProductDetail">
            <div class="min-page clearfix bread-crumb"> <span class="fl crumb-label">当前位置：</span> <span class="fl layui-breadcrumb" lay-separator=">" style="visibility: visible;"> <a lay-href="main">首页</a><span lay-separator="">&gt;</span> <a lay-href="requIndex/financialProducts">金融超市</a><span lay-separator="">&gt;</span> <a><cite>小企业知识产权质押贷</cite></a> </span> </div>
                ...
                <ul class="information">
                  <li> <a lay-href="requIndex/financialInstitutionDetail#?id=324">
                    ...
                    <div class="overflow item-cont">
                      <h2 class="item-title">中国邮政储蓄银行北京分行</h2>
                    </div>
                  </a> </li>
                </ul>
              ...
              <div class="fl page-left">
                <div class="bg-white small-mar-bottom clearfix detail-head">
                  ...
                  <div class="overflow head-cont">
                    <div class="clearfix">
                      ...
                      <h2 class="text-ellipsis head-name">中国邮政储蓄银行北京分行<span class="line-add">—</span><span class="sub-name">小企业知识产权质押贷</span></h2>
                    </div>
                    <div class="product-list cont-info">
                      <ul class="item-info">
                        <li class="fl text-ellipsis"><span class="line-middle info-label">贷款额度：</span><span class="line-middle info-cont" title="5-1000万">1-500万</span></li>
                        <li class="fl box-sizing li-p text-ellipsis"><span class="line-middle info-label">贷款期限：</span><span class="line-middle info-cont">1-12月</span></li>
                        <li class="fl ar text-ellipsis"><span class="line-middle info-label">申请次数：</span><span class="line-middle info-cont">33次</span></li>
                        <li class="fl text-ellipsis"><span class="line-middle info-label">利率范围：</span><span class="line-middle info-cont">面议</span></li>
                        <li class="fl box-sizing li-p text-ellipsis"><span class="line-middel info-label">担保方式：</span><span class="line-middle info-cont" title="抵押">抵押,质押,一般保</span></li>
                      </ul>
                    </div>
                    <div class="clearfix">
                      <ul class="head-info">
                        <li class="fl"> <span class="fl li-label">还款方式：</span>
                          <div class="text-ellipsis"> <span class="li-data">等额本息,一次性还本付息</span> </div>
                        </li>
                        <li class="fl"> <span class="fl li-label">所属机构：</span>
                          <div class="text-ellipsis"> <span class="li-data">中国邮政储蓄银行股份有限公司北京分行</span> </div>
                        </li> <!-- 修改 -->
                ...
                <div class="bg-white overflow detail-cont">
                  <div class="small-mar-bottom cont-page">
                    ...
                    <div class="page-main">
                      <p class="detail-text">缓解轻资产企业融资难题，助力小微企业成长。</p>
                    </div>
                  </div>
                  ...
                  <div id="entry" class="small-mar-bottom cont-page">
                    ...
                    <div class="page-main"> 1、企业或为文创类企业、或为国家高新技术企业、或为中关村高新技术企业。 2、企业连续正常经营2年以上（含2年）且净利润为正值，主业突出，具有核心知识产权，可质押。 3、信誉良好，无不良信用记录，未纳入失信被执行人名单。 4、企业及企业主能够提供一定的资产证明文件。</div>
                  </div>
                  <div class="small-mar-bottom cont-page">
